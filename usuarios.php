...
if (!isset($_SESSION['admin'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['username']) && isset($_POST['password'])) {
        ...
        if ($username === $usuario_admin && $password === $senha_admin) {
            $_SESSION['admin'] = true;
            header("Location: http://localhost/TRF/usuarios.php"); // Redireciona para o painel
            exit();
        } else {
    ...
    // Processar dados do formulário SE enviados via POST
    ...
    // Consulta para orçamentos com valor informado (maior que zero)
    ...
    // Consulta para orçamentos sem valor informado (valor zero, nulo ou vazio)
    ...
    // Dados de demonstração para os gráficos (mantenha ou adapte)
    $dados_mensais = [
        'Jan' => 2,
        'Fev' => 5,
        'Mar' => 8,
...
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php if (isset($login_erro)): ?>
                                <div class="alert alert-danger"><?php echo $login_erro; ?></div>
                            <?php endif; ?>
    ...
    <?php } else { ?>
        ...
        <!-- Modal de Adição de Usuário (Opcional - você pode criar um formulario.php separado) -->
        ...
        <script>
            $(document).ready(function() {
                ...
                // Gráfico de Novos Usuários (adapte os dados conforme sua necessidade)
